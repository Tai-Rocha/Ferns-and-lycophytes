...
s_carioca <- read.csv("./data/Novas_1_May/serra_carioca.csv", sep = ",", dec = ".")

#### Select Point : setup_sdmdata


predics <- list.files("./data/Layers/wc_layers/", pattern = ".tif", full.names = "T")
...
setup_sdmdata(species_name = sp,
              ...
              lon = "longitude", 
              lat = "latitude", 
              models_dir = "./wc_thinning_s_carioca", 
              real_absences = NULL, 
              buffer_type = NULL, 
              dist_buf = NULL, 
              env_filter = FALSE, 
